...
namespace Test.Lansoft.Base
{
	...
	public class TestEntity
	{
		...
		public void Entity_GetValue_str_EncryptVarios_ret_object()
		{
			...
			Assert.IsTrue(Compara.AreEqual(encriptor.EncryptBytes(entity.CampoAByteCorto), bytesEncrypted));
			...
			Assert.IsTrue(Compara.AreEqual(encriptor.EncryptBytes(bytesToEncrypt), bytesEncrypted));
			Assert.IsTrue(Compara.AreEqual(bytesNoEncryptedEsperados, bytesNoEncrypted));
		...
		public void Entity_SetValue_str_object_EncryptVarios_ret_void()
		{
			...
			Assert.IsTrue(Compara.AreEqual(campoAByteCorto, entity.CampoAByteCorto));
			Assert.IsTrue(Compara.AreEqual(campoAByteLargo, entity.CampoAByteLargo));
			string fields = string.Concat("key", encriptor.Encrypt("17"), encriptor.Encrypt("145.96"), encriptor.Encrypt(entity.CampoStr),
